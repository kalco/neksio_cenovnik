...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m0(count) => "Вкупно ${count} производи";

  static m1(version, buildNumber) => "Верзија: ${version} (${buildNumber})";

  final messages = _notInlinedMessages(_notInlinedMessages);
  static _notInlinedMessages(_) => <String, Function> {
    "about" : MessageLookupByLibrary.simpleMessage("Нексио"),
    "aboutNeksio" : MessageLookupByLibrary.simpleMessage("За нексио компјутери"),
    "aboutNeksioDesc" : MessageLookupByLibrary.simpleMessage("Оваа апликиација е неофицијална и не е поддржана од Нексио компјутер.\nСите податоци во оваа апликација се од јавен карактер и не сносувам никаква одговорност за веродостојноста на истите."),
    "contactInfo" : MessageLookupByLibrary.simpleMessage("Контакт информации"),
    "emptyField" : MessageLookupByLibrary.simpleMessage("Внесете го вашето име за да продолжите"),
    "favorite" : MessageLookupByLibrary.simpleMessage("Омилени"),
    "favoriteProducts" : MessageLookupByLibrary.simpleMessage("Омилени производи"),
    "home" : MessageLookupByLibrary.simpleMessage("Почетна"),
    "listAllProduct" : MessageLookupByLibrary.simpleMessage("Дознај цени на повеќе од 1200 производи"),
    "neksioCenovnik" : MessageLookupByLibrary.simpleMessage("Нексио Ценовник"),
    "neksioKompjuteri" : MessageLookupByLibrary.simpleMessage("Нексио Компјутери"),
    "noFavorite" : MessageLookupByLibrary.simpleMessage("Сеуште немате омилени производи"),
    ...
    "searchProductPlaceholder" : MessageLookupByLibrary.simpleMessage("Пребарај производи..."),
    "signIn" : MessageLookupByLibrary.simpleMessage("Внесете го вашето име за до го видите ценовникот."),
